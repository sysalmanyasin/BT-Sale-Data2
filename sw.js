...
const CACHE_NAME = 'bt-sales-v10.82'; // v10.82: Cover dashboard visual refresh (css/cover-dashboard.css + index.html hero strip) — colored borders/glow shadows on KPI tiles, section cards, domain tiles, staff cards, attention chips, and the AI briefing card, plus a small 6-color domain strip under the hero banner. CSS/markup only, no JS logic changed. Bumping so installed PWA clients don't keep serving the stale cached stylesheet.
