...
const CACHE_NAME = 'bt-sales-v10.83'; // v10.83: Cover dashboard section cards (SALES/MANAGER/CLOSING/etc.) were still flat white with only a thin top hairline — gave them a real tinted background wash, a 5px colored left rail, a solid gradient icon chip, and a colored circular chevron button so they read as distinct cards instead of plain list rows. CSS only.
