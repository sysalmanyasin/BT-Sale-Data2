...
const CACHE_NAME = 'bt-sales-v10.19'; // v10.19: Staff Registry cards widened (118px→150px) + name now wraps to 2 lines instead of ellipsis-truncating (css/cover-dashboard.css). Bumped so already-installed clients refetch the changed CSS instead of serving the cached v10.18 copy — same "silently stale" class of bug as every entry below.
