...
const CACHE_NAME = 'bt-sales-v10.84'; // v10.84: STR Report's cover-group used data-group="str", which had no --g-accent/--g-bg assignment in cover-dashboard.css — it was silently falling back to no color at all (plain white, gray icon, gray title), unlike every other section. Assigned it --purple (the one theme color that wasn't already claimed by another group).
