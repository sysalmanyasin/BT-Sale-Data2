...
var _chQuickGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '📊 Open Sheets',            cmd: null, nav: 'notesheets' },
      { label: '🗂 Manage Sheets',          fn: "showPage('notesheets');setTimeout(function(){if(typeof _nsSetPanel==='function')_nsSetPanel('manage')},250)" },
