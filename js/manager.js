...
window.setStaffLogin = setStaffLogin;
window.renderUnmatchedTab = renderUnmatchedTab;
window.resolveUnmatchedToStaff = resolveUnmatchedToStaff;
window.resolveUnmatchedToCategory = resolveUnmatchedToCategory;
window.dismissUnmatched = dismissUnmatched;
